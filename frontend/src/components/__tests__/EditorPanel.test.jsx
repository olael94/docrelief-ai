...
describe("EditorPanel", () => {
  ...
  describe("User Interactions", () => {
    ...
    it("should handle empty content on change", async () => {
      ...
      render(
        <EditorPanel {...defaultProps} content="initial" onChange={onChange} />,
      );
  ...
  describe("Props", () => {
    ...
    it("should handle content updates", () => {
      const { rerender } = render(
        <EditorPanel {...defaultProps} content="initial" />,
      );
  ...
  describe("Edge Cases", () => {
    it("should handle undefined value in onChange", async () => {
      ...
      render(
        <EditorPanel {...defaultProps} content="test" onChange={onChange} />,
      );
