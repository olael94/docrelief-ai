...
describe("Navbar", () => {
  describe("Rendering", () => {
    ...
    it("should render the logo", () => {
      ...
      const logos = screen.getAllByAltText("DocRelief AI");
  ...
  describe("Navigation Links", () => {
    ...
    it("should have home link on logo", () => {
      ...
      const logoLink = screen.getAllByAltText("DocRelief AI")[0].closest("a");
  ...
  describe("Logo", () => {
    ...
    it("should have responsive height classes", () => {
      ...
      // The full logo (desktop) is the first image
      const logo = screen.getAllByAltText("DocRelief AI")[0];
