...
describe('ProgressStep', () => {
  ...
  describe('Status: Pending', () => {
    it('should show gray circle for pending status', () => {
      const { container } = render(<ProgressStep {...defaultProps} status="pending" />);
  ...
  describe('Status: Active', () => {
    ...
    it('should have green loader color', () => {
      ...
      const loader = screen.getByTestId('loader');
      expect(loader).toHaveClass('text-green-500');
    });
  ...
  describe('Layout', () => {
    ...
    it('should have flex-shrink-0 on icon container', () => {
      const { container } = render(<ProgressStep {...defaultProps} status="completed" />);
  ...
  describe('Status Transitions', () => {
    it('should update from pending to active', () => {
      const { rerender } = render(<ProgressStep {...defaultProps} status="pending" />);
    ...
    it('should update from active to completed', () => {
      const { rerender } = render(<ProgressStep {...defaultProps} status="active" />);
  ...
  describe('Different Step Content', () => {
    it('should render different step numbers', () => {
      render(<ProgressStep stepNumber={3} text="Step 3: Process" status="pending" />);

      expect(screen.getByText('Step 3: Process')).toBeInTheDocument();
    });

    it('should handle long step text', () => {
      const longText = 'This is a very long step description that should still render correctly';
  ...
  describe('Edge Cases', () => {
    it('should handle empty text', () => {
      const { container } = render(<ProgressStep stepNumber={1} text="" status="pending" />);
