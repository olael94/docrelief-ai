...
describe('TabBar', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render sliding background indicator', () => {
      ...
      const indicator = container.querySelector('.bg-\\[\\#d9d9d9\\]');
    ...
    it('should highlight active tab', () => {
      ...
      expect(publicTab).toHaveClass('text-black');
    ...
    it('should style inactive tabs differently', () => {
      ...
      const publicTab = screen.getByRole('button', { name: 'GitHub Public' });
      expect(publicTab).toHaveClass('text-gray-600');
  ...
  describe('Indicator Position', () => {
    it('should position indicator based on active tab index', () => {
      const { container } = render(<TabBar {...defaultProps} activeTab="github-public" />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle many tabs', () => {
      ...
      render(<TabBar activeTab="tab0" setActiveTab={vi.fn()} tabs={manyTabs} />);
    ...
    it('should handle tab with empty label', () => {
      ...
      render(<TabBar activeTab="empty" setActiveTab={vi.fn()} tabs={tabsWithEmpty} />);
