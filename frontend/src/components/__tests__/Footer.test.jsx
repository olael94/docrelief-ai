...
describe('Footer', () => {
  ...
  describe('Links', () => {
    ...
    it('should have correct href for GitHub link', () => {
      ...
      expect(githubLink).toHaveAttribute('href', 'https://github.com/olael94/docrelief-ai');
    });
  ...
  describe('Styling', () => {
    it('should have correct base styling classes', () => {
      ...
      expect(footer).toHaveClass('border-zinc-700');
    });
  ...
  describe('Dynamic Year', () => {
    ...
    it('should get year from Date object', () => {
      ...
      const copyright = container.querySelector('[data-testid="footerContent"]');
