      ...
      <div className="w-[340px] md:w-[660px] flex flex-col items-center h-full min-h-[500px]">
        ...
        <div
          className={`bg-[#1C2B3A]/60 backdrop-blur-md rounded-3xl w-full h-[200px] cursor-pointer transition-colors ${
            isDragging
              ? "border-2 border-green-400 shadow-[0_0_20px_rgba(34,197,94,0.25)]"
        ...
        {files.length > 0 ? (
          <div className="w-full mt-4 p-4 bg-white border-2 border-gray-200 rounded-lg flex items-center justify-between">
          ...
          <p className="self-start pt-4 pb-4 font-fire-code text-white">
        ...
        <div className="mt-auto mb-9">
          <HeroButton
            text={
              isSubmitting ? "Uploading..." : "Generate README from Files →"
            }
