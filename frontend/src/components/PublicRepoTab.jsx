...
export default function PublicRepoTab() {
  ...
  return (
    <div className="w-full flex flex-col items-center h-full min-h-[500px]">
      <h1 className="font-fire-code text-green-200 self-start pt-4 pb-4">
        Repository URL
      </h1>
      <input
        ...
        onKeyPress={(e) =>
          e.key === "Enter" && !isSubmitting && handleGenerate()
        }
      ...
      <span className="mt-auto mb-4 text-bold text-gray-500 ">
        Use this tab for public Github Repositories
      </span>
    </div>
  );
}
