...
export default function PublicRepoTab() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-w-125">
            ...
            <input className="bg-navbar rounded-3xl p-2 w-full text-center" type="text" placeholder="https://github.com/username/repo" value={repoUrl} onChange={(e) => setRepoUrl(e.target.value)}></input>
