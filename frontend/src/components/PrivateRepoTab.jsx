...
export default function PrivateRepoTab() {
  ...
  const fetchDefaultBranch = async (repo) => {
    ...
    try {
      ...
      console.log(
        `Default branch: ${defaultBranchInfo?.name}, Has README: ${defaultBranchInfo?.has_readme}`,
      );
    } catch (error) {
      toast.error(error.message);
  ...
  const handleDisconnect = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        toast(
          "To fully revoke access, visit GitHub Settings → Applications → Authorized OAuth Apps",
          {
            duration: 8000,
            icon: "ℹ️",
          },
            ...
            <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-yellow-400/80 mt-1">
                        This branch already contains a README.md file.
                        Generating a new README will overwrite the existing one.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center pt-2">
                ...
                >
                  {loadingBranch
                    ? "Loading..."
                    : `Generate README for ${selectedRepo.name}`}
                </button>

                <p className="text-xs text-gray-500 text-center mt-2">
                  This will analyze your repository and generate a professional
                  README
                </p>
              </div>
            </div>
      ...
      <div className="rounded-lg">
        <div className="max-w-md mx-auto text-center items-center space-y-6">
          ...
          <p className="text-green-200">
            Connect your GitHub account to generate READMEs for your private
            repositories
          </p>
          ...
          <div className="space-y-3 text-left">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-white">
                Private repos require authentication to access code
              </p>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle2 className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
