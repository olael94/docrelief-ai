    ...
    <>
      ...
      <div className="mt-20 mb-10 flex flex-col items-center justify-center px-4">
        ...
        <h2 className="mt-7 mb-7 font-fire-code text-2xl text-white text-center">
          Stop writing READMEs from scratch. Let AI generate and commit directly
          to your GitHub.
        </h2>
        ...
        <div className="w-[400px] md:w-[921px] h-auto pt-16 md:px-5 rounded-4xl shadow-2xl flex flex-col items-center gap-8 py-8 bg-[#1C2B3A]/60 backdrop-blur-md border border-green-500/40 shadow-[0_0_20px_rgba(34,197,94,0.15)]">
          <h1 className="font-urbanist text-4xl text-green-500 font-black">
            Generate README
          </h1>
