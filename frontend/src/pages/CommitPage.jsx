...
import { Loader2, GitPullRequest, GitBranch, FileText, Info, ArrowLeft, Check } from 'lucide-react';
  ...
  const handleCommit = async () => {
    ...
    try {
      ...
      if (!err.response && err.message && err.message.includes('Network Error')) {
        ...
        const errorMessage = err.response?.data?.detail || err.message || 'Failed to commit README';
