  ...
  return (
      ...
      <div className="flex items-center justify-center gap-3 mt-8 mb-6 px-6">
        ...
        <input
            ...
            className="flex-1 max-w-xl px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
        <button
